...
def main():
    ...
    # Test adding queries
    query1_id = db.add_query(
        "Who is Johnny Silverhand?", "character", "silverhand_query"
    )
    query2_id = db.add_query(
        "What happened at Arasaka Tower?", "event", "arasaka_event"
    )
    ...
    qrels.add_judgment(
        ...
        3,
        "character",
        "Johnny Silverhand was a rockerboy...",
    )
    qrels.add_judgment(
        "Who is Johnny Silverhand?", "doc2", 2, "character", "The infamous terrorist..."
    )
    qrels.add_judgment(
        "Who is Johnny Silverhand?",
        "doc3",
        1,
        "character",
        "Some tangential reference...",
    )
    qrels.add_judgment(
        "Who is Johnny Silverhand?", "doc4", 0, "character", "Unrelated document..."
    )

    qrels.add_judgment(
        "What happened at Arasaka Tower?",
        "doc5",
        3,
        "event",
        "The bombing of Arasaka Tower...",
    )
    qrels.add_judgment(
        "What happened at Arasaka Tower?",
        "doc6",
            ...
            "results": [
                {
                    ...
                    "vector_score": 0.92,
                    "text_score": 0.98,
                    "text": "Johnny Silverhand was a rockerboy...",
                    "source": "lore",
                },
                {
                    "id": "doc2",
                ...
                },
                {
                    ...
                    "vector_score": 0.62,
                    "text_score": 0.68,
                    "text": "Some tangential reference...",
                    "source": "lore",
                },
                {
                    "id": "doc4",
            ...
            "results": [
                {
                    ...
                    "vector_score": 0.90,
                    "text_score": 0.94,
                    "text": "The bombing of Arasaka Tower...",
                    "source": "lore",
                },
                {
                    "id": "doc6",
    ...
    try:
        ...
        logger.warning(
            "Could not import ir_metrics module, skipping metrics calculation"
        )
