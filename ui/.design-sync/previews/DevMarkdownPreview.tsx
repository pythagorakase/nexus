...
// deep-heading floor check) plus a player-voice line and instant pending
// prose — the exact .reader / .prose-block / .md-part markup NarrativePane
// uses. Rendered in the default Veil theme inside a sized, clipped viewport
// box so the 100vh reader frame resolves and the prose stays in-frame.
