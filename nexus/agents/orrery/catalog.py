...
_register(
    ...
    lambda m: f"{_slot(m.group('slot'))} is the project's stored institution",
)
_register(
    r"project_faction_is_active\((?P<slot>\w+)\)",
    lambda m: f"{_slot(m.group('slot'))} is the project's active stored institution",
)
