"""
Refactored Structured Output Schemas for LOGON
===============================================

This refactored version addresses:
1. Support for creating new entities (characters, places, factions)
2. Alignment with database ENUMs
3. Removal of deprecated metadata fields
4. Proper FK relationships for locations
5. Interval-based timekeeping
6. Character/relationship schema fixes
...
from nexus.agents.lore.logon_schemas_enums import (
    AgentType,
    EmotionalValence,
    EntityType,
    FactionMemberRole,
...
logger = logging.getLogger("nexus.lore.logon_schemas_refactored")
