# GAIA Agent Blueprint (World Tracker)

## Overview

GAIA (World Tracker) is responsible for monitoring and maintaining the state of the narrative world, including locations, factions, objects, and global conditions. It tracks changes to the world over time, understands causal relationships between world events, and ensures world-state consistency across the narrative.
