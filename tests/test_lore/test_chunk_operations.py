...
class TestChronologicalAssembly:
    ...
    def test_assemble_chronological_basic(self):
        ...
        warm_chunks = [{"id": 5, "text": "chunk5"}, {"id": 10, "text": "chunk10"}]
        augment_chunks = [{"id": 3, "text": "chunk3"}, {"id": 7, "text": "chunk7"}]
...
class TestChunkFormatting:
    ...
    def test_format_chunk_non_primary_layer(self):
        ...
        chunk = {"world_layer": "flashback", "raw_text": "Flashback scene"}
...
class TestChunkMerging:
    ...
    def test_merge_deduplicate_basic(self):
        ...
        chunks1 = [{"id": 1, "text": "chunk1"}, {"id": 3, "text": "chunk3"}]
        chunks2 = [
            {"id": 2, "text": "chunk2"},
